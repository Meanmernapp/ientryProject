...
import { CreateEmployeeProvider, CreateEmployeeProviderPreUser, GetEmployeeProviderByEmail, GetEmployeeProviderByPhoneNumber } from "../reduxToolkit/EmployeeProviders/EmployeeProvidersApi";
const AddUpdateProviderContractor = ({
  ...
  const formHandle = () => {
    ...
    dispatch(CreateEmployeeProvider(body))
    dispatch(GetEmployeeProviderByEmail(body))
    dispatch(GetEmployeeProviderByPhoneNumber(body))
  }
